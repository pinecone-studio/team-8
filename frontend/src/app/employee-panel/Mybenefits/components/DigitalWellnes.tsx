          ...
          <div className="flex flex-col lg:flex-row gap-6">
            ...
            <div className="flex-1 bg-white border rounded-2xl p-8 shadow-sm">
              <div className="flex justify-between items-start mb-6">
                <div>
                  <h1 className="text-2xl font-semibold">Digital Wellness</h1>
                  <p className="text-gray-500 mt-1">Calm & Headspace</p>
                </div>
              ...
              <p className="text-gray-600 mb-8">
                Meditation, focus, and sleep tools to support mental wellbeing
              </p>
              ...
              <div className="border-t pt-6 grid grid-cols-2 gap-10">
                ...
                <div>
                  ...
                  <p className="text-xl font-semibold mt-1">No</p>
                </div>
              </div>

              <div className="border-t mt-8 pt-6 text-gray-500 text-sm flex items-center gap-2">
                <span>📄</span>
                Access is granted automatically after request approval
              </div>
            </div>
            ...
            <div className="w-full lg:w-[360px] bg-white border rounded-2xl p-6 shadow-sm">
              ...
              <div className="space-y-5">
                <Item title="Employment Status" desc="Open to all employees" />
                <Item
                  title="Account Requirement"
                  desc="Use your company email to activate"
                />
                <Item
                  title="Usage Policy"
                  desc="One primary subscription per employee"
                />
                <Item title="Responsibility Level" desc="No minimum level" />
              </div>
