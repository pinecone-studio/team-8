...
export default function PrivateHealth() {
  return (
            ...
            <div className="flex-1 bg-white border rounded-2xl p-8 shadow-sm">
              <div className="flex justify-between items-start mb-6">
                <div>
                  ...
                  <p className="text-gray-500 mt-1">HealthPlus</p>
                </div>
              ...
              <div className="border-t mt-8 pt-6 text-gray-500 text-sm flex items-center gap-2">
                <span>📄</span>
                Coverage starts after enrollment approval
              </div>
            </div>
            ...
            <div className="w-full lg:w-[360px] bg-white border rounded-2xl p-6 shadow-sm">
              ...
              <div className="space-y-5">
                ...
                <Item
                  ...
                  desc="Completed at least 3 months"
                />
                <Item
                  title="Coverage Type"
                  desc="Employee only or family plan"
                />
